...
public static class EducationMessages
{
    ...
    #region Formatlama - Fluent Validation
        ...
        public const string NameBosOlmamali = "Okul boş olmamalıdır.";
        ...
        public const string NameMaxKarakter = "Okul 'Name' alanı en fazla 250 karakter olmalıdır.";
        ...
        public const string NameMinKarakter = "Okul 'Name' alanı en az 3 karakter olmalıdır.";
        public const string FieldOfStudyMinKarakter = "Okul 'FieldOfStudy' alanı en az 3 karakter olmalıdır.";
        #endregion
    #endregion
}